package com.jiwon.spring.ex.jsp;
...
import com.jiwon.spring.ex.jsp.bo.NewUserBO;
...
//	@ResponseBody
	public String addUser(
			...
			, @RequestParam("introduce") String introducce
			, Model model) {
		
//		int count = newUserBO.addUser(name, birthday, email, introducce);
//		return "삽입 결과 : " + count;
